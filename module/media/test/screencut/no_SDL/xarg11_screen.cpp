...
int main(int argc, char* argv[])
{
	...
	//av_dict_set(&options,"video_size","1080x720",0);
...
#else
						if (!pFrameYUV->data[0])
							pFrameYUV->data[0] = (uint8_t*)malloc(1920*1080*8); 
						if (!pFrameYUV->data[1])
							pFrameYUV->data[1] = (uint8_t*)malloc(1920*1080*8>>2); 
						if (!pFrameYUV->data[2])
							pFrameYUV->data[2] = (uint8_t*)malloc(1920*1080*8>>2); 

						pFrameYUV->linesize[0]= 1920;
						pFrameYUV->linesize[1]= 1920/2;
						pFrameYUV->linesize[2]= 1920/2;
#endif
